...
\begin{enumerate}
    ...
    \item[\textbf{4.1.1.}] $11$
    \item[\textbf{4.1.2.}] $\dfrac{1}{6}\left(\displaystyle\binom{n+2}{2}+3\lfloor{\dfrac{k}{2}+1}\rfloor+2(3 \mid k)\right)$, where $(3|k)$ is a boolean function outputting whether $k$ is divisible by $3$.
